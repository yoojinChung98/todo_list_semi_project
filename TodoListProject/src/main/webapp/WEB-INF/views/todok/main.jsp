...
<body>
  <div class="main-eLH">
    <div class="auto-group-2bkm-y7f">
      ...
      <div class="calendar-HPF">
        <div class="calheader-nL1">
          <div class="auto-group-bh6z-tdw">
            <img class="leftbtn-2EM" src="./assets/leftbtn.png" />
            <div class="yearmonth-YTb">2023년 10월</div>
            <img class="rightbtn-2tZ" src="./assets/rightbtn.png" />
          </div>
          <img class="calbottomline-MA9" src="REPLACE_IMAGE:138:230" />
        </div>
        <div class="caldays-suB">
          <div class="days-Rfo">
            <img class="daybox-BQ5" src="./assets/daybox-Z8d.png" />
            <div class="sun-7oX">일</div>
          </div>
          <div class="auto-group-cjxt-byb">
            <div class="days-LgH">
              <img class="daybox-hFw" src="./assets/daybox-RnR.png" />
              <div class="mon-SDX">월</div>
            </div>
            <div class="days-8s3">
              <img class="daybox-Vhb" src="./assets/daybox.png" />
              <div class="tue-FRs">화</div>
            </div>
            <div class="days-ME1">
              <img class="daybox-hYm" src="./assets/daybox-2tq.png" />
              <div class="wen-rRf">수</div>
            </div>
            <div class="days-Z5B">
              <img class="daybox-WWD" src="./assets/daybox-y3X.png" />
              <div class="tur-GEV">목</div>
            </div>
            <div class="days-dUM">
              <img class="daybox-Bkm" src="./assets/daybox-C3s.png" />
              <div class="fri-wE9">금</div>
            </div>
            <div class="days-3HB">
              <img class="daybox-oGM" src="./assets/daybox-pWD.png" />
        ...
        <div class="recommain-CNu">
          ...
          <div class="recomtodo-Fry">
            ...
            <div class="auto-group-drq3-G9o">
              ...
              <img class="like-Umf" src="./assets/like-hRT.png" />
            </div>
          </div>
        </div>
        <div class="mostlikemain-jhb">
          ...
          <div class="mostliketodo1-z7j">
            ...
            <div class="auto-group-zp4z-EwB">
              ...
              <img class="like-TJ9" src="./assets/like-RBX.png" />
            </div>
          </div>
          <div class="mostliketodo2-vBj">
            ...
            <div class="auto-group-mmry-hER">
              ...
              <img class="like-weZ" src="./assets/like-p41.png" />
            </div>
          </div>
          <div class="mostliketodo3-DMB">
            ...
            <div class="auto-group-dwd3-dJR">
              ...
              <img class="like-dhj" src="./assets/like-71j.png" />
            </div>
          </div>
        </div>
      ...
      <div class="todayslist-j8V">
        ...
        <div class="haveto-Voo">
          <img class="checkbox-dQD" src="./assets/checkbox-nochecked.png" />
          <!-- 체크된 이미지 : "./assets/checkbox-checked.png" -->
          <p class="todotext-A9F">React 공부하기</p>
        </div>
        <div class="todobottom-62u">
          <div class="auto-group-nalr-Q3b">할 일을 입력 후 ENTER를 눌러주세요</div>
          <img class="doplusbtn-sxm" src="./assets/doplusbtn-8rD.png" />
        </div>
      </div>
    ...
    <div class="mainheader-LrM">
      ...
      <img class="todoksidelogo-78M" src="./assets/todoksidelogo-weZ.png" />
    </div>
  </div>
</body>