...
<body>
  ...
  <div class="login-o3w">
    ...
    <form action="${pageContext.request.contextPath}/todok/login" method="post" name="loginForm">
      <div class="loginbox-6BT">
        <div class="auto-group-xsar-2L1">
          ...
          <button type="submit" class="loginbtn-ghP" id="loginBtn">로그인</button><br /><br />
        </div>
    </form>
    <button type="button" class="joinbtn-3CV" id="joinBtn-111" style="text-decoration: none;"><a
  ...
  <script type="text/javascript">
    if (sessionStorage.getItem('userId')) {
      ...
      var targetPage = "http://localhost/todoproject/main";
    ...
    // var naver_id_login = new naver_id_login("W7Mq7kXYF3dBqzpj2kxG", "http://localhost/todoproject/main");
    ...
    //   if (state !== null) {
    //     fetch('${pageContext.request.contextPath}/todok/login/naver/' + signal)
    //   }
    // }
    ...
    if (msg === 'Success') {
      ...
      var targetPage = "${pageContext.request.contextPath}/main";
