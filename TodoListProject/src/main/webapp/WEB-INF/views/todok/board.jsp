  ...
  <div class="board-xLZ">
    <div class="auto-group-skmt-U41">
      ...
      <div class="regboardinputbox-WWV">
        <div class="regboarduserprofile-1y3" name="profileColor" id="profileColor"></div>
        <div class="auto-group-d2mf-VdK">
          <div class="regboarduser-dDj" name="nickName" id="nickName" readonly></div>
          <textarea class="auto-group-naob-iky" name="content" maxlength="40" id="content"
            placeholder="당신이 생각하는 색다른 할 일을 모두에게 추천해주세요~" spellcheck="false"></textarea>
        </div>

        <button type="button" id="registBtn" style="margin-top: 88px; border: none; background: transparent">
    ...
    <div class="boardorderbtn-oA9">
      <button type="button" id="newBtn" value="1" class="recomdorderbtn-WqF">등록순</button>
      <button type="button" id="bestBtn" value="2" class="latestorderbtn-LpH">인기순</button>
    </div>
